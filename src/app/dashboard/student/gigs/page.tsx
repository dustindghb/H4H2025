...
const sampleProjects: Project[] = [
  {
    ...
    description:
      "We are launching a new line of eco-friendly home products and need a skilled marketer to design and execute a high-impact social media campaign.",
    skills: [
      "Marketing",
      "Social Media",
      "Content Creation",
  ...
  },
  {
    ...
    description:
      "Seeking a finance professional to generate a comprehensive financial analysis report for our startup’s first-year performance.",
    skills: [
      "Financial Analysis",
      "Excel",
      "Data Visualization",
  ...
  },
  {
    ...
    description:
      "Looking for a creative designer to revamp our brand identity and create a cohesive visual language.",
    skills: [
      "Graphic Design",
      "Adobe Photoshop",
      "Illustrator",
  ...
  },
  {
    ...
    description:
      "Seeking an AI developer to create an advanced chatbot for customer support automation.",
    skills: [
      "AI",
      "Machine Learning",
      "Python",
  ...
  },
  {
    ...
    description:
      "Seeking a writer to produce high-quality blog articles on trending tech topics.",
    skills: [
      "Writing",
      "SEO",
      "Research",
  ...
  },
  {
    ...
    description:
      "Seeking a cybersecurity expert to conduct a comprehensive audit of our financial institution’s security systems.",
    skills: [
      "Cybersecurity",
      "Networking",
      "Penetration Testing",
  ...
  },
  {
    ...
    description:
      "Looking for an experienced event planner to coordinate a corporate event for 200+ attendees.",
    skills: [
      "Event Planning",
      "Budgeting",
      "Vendor Coordination",
  ...
  },
  {
    ...
    description:
      "Develop an interactive e-learning platform for students and professionals.",
  ...
  },
  {
    ...
    description:
      "Seeking a mobile app developer to create a fitness tracking app for iOS and Android.",
    skills: [
      "Mobile Development",
      "Flutter",
      "Firebase",
  ...
  },
  {
    ...
    description:
      "Conduct market research to identify opportunities for a new product in the health and wellness industry.",
    skills: [
      "Market Research",
      "Data Analysis",
      "Survey Design",
  ...
  },
  {
    ...
    description:
      "Seeking a video production team to create a series of training videos for our corporate onboarding program.",
    skills: [
      "Video Production",
      "Scriptwriting",
      "Editing",
  ...
  },
  {
    ...
    description:
      "Looking for a supply chain expert to analyze and optimize our logistics and distribution processes.",
    skills: [
  ...
  },
  {
    ...
    description:
      "Redesign and optimize an existing e-commerce website to improve user experience and increase conversions.",
  ...
  },
  {
    ...
    description:
      "Provide expert advice on implementing sustainable practices in a manufacturing facility.",
    skills: [
      "Sustainability",
  ...
  },
  {
    ...
    description:
      "Produce a high-quality podcast series to showcase thought leadership in the tech industry.",
    skills: [
      "Audio Editing",
      "Scriptwriting",
      "Podcasting",
  ...
  },
  {
    ...
    description:
      "Develop an AI-driven tool to streamline the recruitment process for HR teams.",
  ...
  },
  {
    ...
    description:
      "Design a modern and functional interior for a new co-working space.",
    skills: [
      "Interior Design",
      "Space Planning",
      "3D Rendering",
  ...
  },
  {
    ...
    description:
      "Develop a data analytics dashboard to track patient outcomes and operational efficiency.",
    skills: [
      "Data Analytics",
      "Tableau",
      "SQL",
  ...
  },
  {
    ...
    description:
      "Plan and execute a crowdfunding campaign to raise funds for a social impact project.",
    skills: [
      "Crowdfunding",
      "Marketing",
      "Social Media",
  ...
  },
  {
    ...
    description:
      "Develop an augmented reality (AR) app to enhance the online shopping experience.",
    skills: [
      "AR Development",
      "Unity",
      "3D Modeling",
  ...
  },
  {
    ...
    description:
      "Develop a comprehensive crisis management plan for a financial institution.",
    skills: [
      "Risk Management",
  ...
  },
  {
    ...
    description:
      "Develop a gamified learning app to help kids aged 6-10 learn math and science concepts.",
    skills: [
      "Game Development",
